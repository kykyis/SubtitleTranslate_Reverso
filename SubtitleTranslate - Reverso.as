/*
        real time subtitle translate for PotPlayer using Reverso
*/
...
string JsonParse(string json) {
    ...
    if (Reader.parse(json, Root) && Root.isObject()) {
        JsonValue translation = Root["translation"][0];
...
string GetTitle() {
        return "{$CP950=Reverso 翻譯$}{$CP0=Reverso translate$}";
}
...
string Translate(string Text, string &in SrcLang, string &in DstLang) {
    ...
    string url = "https://api.reverso.net/translate/v1/translation";
    ...
    string post_data =  "{\"format\":\"text\",\"from\":\"" + SrcLang + "\",\"to\":\"" + DstLang + "\",\"input\":\"" + Text + "\",\"options\":{\"languageDetection\":true,\"sentenceSplitter\":true, \"origin\":\"chromeextension\"}}";
